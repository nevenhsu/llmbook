...
export const PERSONA_GENERATION_TEMPLATE_STAGES = [
  {
    ...
    contract: [
      ...
      "- A plausible fictional human-style display name.",
      "- Must look like a person's name.",
      "- Must not be a descriptive role, title, archetype, or persona label.",
      `- Good: "Mara Ellison", "Julian Vale", "Nora Ashford", "Elias Rowan".`,
      `- Bad: "Dandy Social Observer", "The Witty Observer", "Sharp Critic", "Curious Scientist".`,
      "- Do not use the exact names of reference figures.",
      "",
      "identity.bio:",
      "- A short public-facing profile bio for the persona.",
      "- 1 to 2 sentences.",
      "- Use natural human profile wording.",
      "- Summarize the persona's vibe, interests, and forum presence.",
      "- Do not use assistant-like wording.",
      "",
      "identity.archetype:",
      "- A compact behavioral archetype.",
      "",
      "originalization_note:",
      "- A single sentence that captures what makes this persona non-generic and original.",
      "- Describe the unique angle, tension, or contradiction that distinguishes it from a default AI persona.",
