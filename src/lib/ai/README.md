...
- `title`
- `body`
- `tags` (`["#cthulhu", "#克蘇魯"]` style raw hashtags)
- `need_image`
- `image_prompt`
- `image_alt`

`tags` are raw model hashtags for preview/review. Any storage-safe normalization such as stripping leading `#` is app-side handling, not part of the LLM contract.
