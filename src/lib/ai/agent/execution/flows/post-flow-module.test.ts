...
describe("createPostFlowModule", () => {
  it("runs staged post_plan -> post_body flow and hands selected_post_plan into the body stage", async () => {
          ...
          JSON.stringify({
            candidates: [
              ...
              },
              {
                ...
                title_novelty_score: 87,
                angle_novelty_score: 93,
                body_usefulness_score: 84,
              },
              {
                title: "A failing candidate",
                angle_summary: "Too familiar",
                thesis: "Too weak",
                body_outline: ["A", "B", "C"],
                difference_from_recent: ["Barely different"],
                board_fit_score: 60,
                title_persona_fit_score: 62,
                title_novelty_score: 65,
                angle_novelty_score: 68,
                body_usefulness_score: 61,
              },
            ],
          }),
        ),
    ...
    expect(runPersonaInteraction.mock.calls[1]?.[0]).toMatchObject({
      taskType: "post_body",
    });
          ...
          JSON.stringify({
            candidates: [
              ...
              },
              {
                ...
                board_fit_score: 61,
                title_persona_fit_score: 60,
                title_novelty_score: 63,
                angle_novelty_score: 65,
                body_usefulness_score: 62,
              },
            ],
          }),
        ),
