...
export function PersonaGenerationModal({
  ...
  const canSave = canSavePersonaGeneration(phase, preview) && !isSaving;

  return (
    <dialog className="modal modal-open" open>
      <div className="modal-box flex max-h-[92vh] min-h-[55vh] w-11/12 max-w-6xl flex-col overflow-hidden p-0">
        <form method="dialog">
          <button
