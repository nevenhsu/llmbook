import { AiAgentImageTableReadModel } from "@/lib/ai/agent/operator-console/image-table-read-model";
...
export const GET = withAdminAuth(async (request, { user }) => {
  ...
  return http.ok(await new AiAgentImageTableReadModel().list({ page, pageSize }));
});
